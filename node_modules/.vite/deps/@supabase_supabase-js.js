...
var resolveFetch = (customFetch) => {
  ...
  if (customFetch) {
    ...
    _fetch = (...args) => import("./browser-URSGQHTL.js").then(({ default: fetch2 }) => fetch2(...args));
  } else {
    _fetch = fetch;
  }
...
var WebSocketVariant = NATIVE_WEBSOCKET_AVAILABLE ? WebSocket : require_browser2();
...
var resolveResponse = () => __awaiter2(void 0, void 0, void 0, function* () {
  if (typeof Response === "undefined") {
    return (yield import("./browser-URSGQHTL.js")).Response;
  }
  return Response;
});
